...
Ensure the RabbitMQ server is installed and running. RabbitMQ is used for asynchronous message processing, such as appointment 
...
Open the URL displayed in the terminal (typically https://localhost:<port>) to access the Admin Portal.
________________________________________
