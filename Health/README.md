...
A full-stack Healthcare Management System built with ASP.NET Core Web API, Angular, Blazor Server, SQL Server, RabbitMQ, JWT Authentication, Jenkins, and AWS.
Features
...
dotnet run
Open the URL displayed in the terminal (typically https://localhost:<port>) to 
access the Admin Portal.
________________________________________

AWS Deployment
________________________________________
The application is deployed to AWS using a Continuous Integration and Continuous Deployment (CI/CD) pipeline powered by Jenkins. The deployment process is as follows:
