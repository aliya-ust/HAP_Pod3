...
namespace HealthCare.Tests.Services
{
    public class HealthRecordServiceTests
    {
        ...
        private readonly Mock<ILogger<HealthRecordService>> _logger = new();
                ...
                Items = new List<HealthRecord>
        {
            ...
            _mapper.Setup(x =>
                x.Map<IEnumerable<HealthRecordListDto>>(paged.Items))
        ...
        [Fact]
        public async Task GetHealthRecordByAppointment_ShouldReturnEmpty()
        {
            _repository.Setup(x =>
                x.GetHealthRecordByAppointment(1))
                .ReturnsAsync(new List<HealthRecordListDto>());
