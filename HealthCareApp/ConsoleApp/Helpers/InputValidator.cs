...
namespace HealthApp.ConsoleApp.Helpers
{
    ...
    public static class InputValidator
    {
        ...
        public static bool IsValidName(string input)
        {
            ...
            return Regex.IsMatch(input.Trim(), pattern,RegexOptions.None,TimeSpan.FromSeconds(1));
        }
        ...
        public static bool IsValidInsuranceId(string input) =>
             ...
             Regex.IsMatch(input, @"^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]+$", RegexOptions.None, TimeSpan.FromSeconds(1));
