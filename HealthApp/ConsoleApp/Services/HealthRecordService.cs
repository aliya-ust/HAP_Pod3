...
namespace HealthApp.ConsoleApp.Services
{
    public class HealthRecordService : IHealthRecordService
    {
        ...
        public string AddRecord(HealthRecord record)
        {
            ...
            Doctor doctor = _doctorRepository.GetDoctorById(record.Doctor.DoctorId);
        ...
        public string Update(HealthRecord updatedRecord)
        {
            ...
            updatedRecord.Doctor = _doctorRepository.GetDoctorById(updatedRecord.Doctor.DoctorId);
