namespace HealthApp.ConsoleApp.Models
{
    public class HealthRecord
    {
        ...
        {
            return $"Record Id: {RecordId} | Patient: {Patient.Name} | Doctor: {Doctor.FullName} | Visit Date: {VisitDate.ToShortDateString()} | Diagnosis: {Diagnosis} | Prescription: {Prescription} | Doctor Notes: {DoctorNotes}";
        }
    }
}