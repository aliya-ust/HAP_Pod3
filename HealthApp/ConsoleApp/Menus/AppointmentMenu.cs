...
        public AppointmentMenu(IAppointmentService appointmentService,IPatientService patientService, IDoctorService doctorService)
        {
        ...
        public void BookAppointment()
        {
            try
            {
                ...
                string rawPatient = InputValidator.GetValidatedInput("  Enter Patient ID : ",InputValidator.IsValidId,"  Please enter a valid positive number.")!;
                ...
                var bookedSlots = _appointmentService.GetAllAppointments().Where(a => a.ScheduledDate.Date == selectedDate.Date &&a.Status != AppointmentStatus.Cancelled).Select(a => a.TimeSlot).ToList();
                ...
                while (true)
                {
                    ...
                    var appt = _appointmentService.BookAppointment(patient!, doctor, selectedDate, selectedSlot);
        ...
        public void ViewPatientAppointments()
        {
            try
            {
                ...
                // Get and validate patient ID
                string raw = InputValidator.GetValidatedInput("  Enter Patient ID : ",InputValidator.IsValidId,"  Please enter a valid positive number.")!;
        ...
        public void ConfirmOrCancel()
        {
            try
            {
                ...
                string raw = InputValidator.GetValidatedInput("\n  Enter Appointment ID : ",InputValidator.IsValidId,"  Please enter a valid positive number.")!;
...
                    string reason = InputValidator.GetValidatedInput("  Reason for cancellation : ",InputValidator.IsValidCancellationReason,"  Reason cannot be empty.")!;
        ...
        public void CompleteAppointment()
        {
            try
            {
                ...
                var confirmed = _appointmentService.GetUpcomingAppointments().Where(a => a.Status == AppointmentStatus.Confirmed).ToList();
