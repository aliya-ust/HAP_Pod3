...
dotnet sonarscanner begin ^
  ...
  /d:sonar.coverage.exclusions="**/bin/**,**/obj/**,**/Migrations/**,**/Middleware/**,**/Controllers/**,**/Exceptions/**,**/Data/**,**/DTOs/**,**/Mappings/**,**/Models/**,**/Properties/**,**/Repositories/**,**/HealthCare.Shared/**,**/HealthCare.UsersAngular/**,**/HealthCare.AdminBlazor/**,**/Program.cs" ^
