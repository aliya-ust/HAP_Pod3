    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorAvailableSlots", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 800m, "Dr. Anil Mehta", true, "Cardiology", 1, 12 });

            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "PatientId", "DateOfBirth", "FullName", "Gender", "InsuranceId", "IsActive", "PhoneNumber", "UserId" },
                values: new object[] { 1, new DateOnly(1990, 5, 12), "Arjun Raj", "Male", "INS200", true, "9876543210", 2 });
