...
namespace HealthCareApi.Services.Implementations
{
    public class PatientService : IPatientService
    {
        ...
        public async Task<IEnumerable<Patient>> GetPaginatedPatientAsync(string searchTerm = null, int pageNumber = 1, int pageSize = 10)
        {
            return await _patientRepository.GetPaginatedPatientsAsync(searchTerm, pageNumber, pageSize);
        }
